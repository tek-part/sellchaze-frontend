...
export const LUXURY_CATALOG: DemoCatalog = {
  ...
  currency: CUR,
  products: [
    product({ i: 1, title: 'Wool-Cashmere Overcoat', price: 890, vendor: 'Sellchaze', photo: 'photo-1490481651871-ab68de25d43d', hover: 'photo-1483985988355-763728e1935b', rating: 4.8, reviews: 164, badge: 'Best seller', currency: CUR, colors: ['Ivory', 'Camel', 'Black'], sizes: ['XS', 'S', 'M', 'L', 'XL'], material: 'Wool', tags: ['new-season'], categorySlug: 'outerwear', categoryName: 'Outerwear' }),
    product({ i: 2, title: 'Silk Column Dress', price: 620, vendor: 'Sellchaze', photo: 'photo-1595777457583-95e059d581b8', rating: 4.7, reviews: 218, currency: CUR, colors: ['Black', 'Navy'], sizes: ['S', 'M', 'L'], material: 'Cashmere', tags: ['bestseller'], categorySlug: 'dresses', categoryName: 'Dresses' }),
    ...
    product({ i: 4, title: 'Ribbed Cashmere Knit', price: 390, vendor: 'Sellchaze', photo: 'photo-1523381210434-271e8be1f52b', rating: 4.9, reviews: 587, currency: CUR, colors: ['Camel', 'Oatmeal'], sizes: ['XS', 'S', 'M', 'L', 'XL'], material: 'Linen', tags: ['limited'], categorySlug: 'knitwear', categoryName: 'Knitwear' }),
    ...
    product({ i: 7, title: 'Structured Wool Blazer', price: 640, vendor: 'Sellchaze', photo: 'photo-1592878904946-b3cd8ae243d0', rating: 4.7, reviews: 231, currency: CUR, colors: ['Charcoal', 'Ivory'], sizes: ['XS', 'S', 'M', 'L', 'XL'], material: 'Wool', tags: ['bestseller'], categorySlug: 'tailoring', categoryName: 'Tailoring' }),
    ...
    product({ i: 11, title: 'Belted Trench Coat', price: 720, vendor: 'Sellchaze', photo: 'photo-1539533018447-63fcce2678e3', rating: 4.7, reviews: 176, currency: CUR, colors: ['Charcoal', 'Ivory'], sizes: ['S', 'M', 'L'], material: 'Cotton', tags: ['new-season'], categorySlug: 'outerwear', categoryName: 'Outerwear' }),
    ...
    product({ i: 14, title: 'Cashmere Wrap Coat', price: 1180, vendor: 'Sellchaze', photo: 'photo-1519710164239-da123dc03ef4', rating: 4.9, reviews: 94, badge: 'Limited', currency: CUR, colors: ['Black', 'Navy'], sizes: ['S', 'M', 'L'], material: 'Cashmere', tags: ['limited'], categorySlug: 'outerwear', categoryName: 'Outerwear' }),
    ...
    product({ i: 16, title: 'Fine-Gauge Cardigan', price: 310, vendor: 'Sellchaze', photo: 'photo-1576871337622-98d48d1cf531', rating: 4.6, reviews: 412, soldOut: true, currency: CUR, colors: ['Camel', 'Oatmeal'], sizes: ['XS', 'S', 'M', 'L', 'XL'], material: 'Linen', tags: ['new-season'], categorySlug: 'knitwear', categoryName: 'Knitwear' }),
  ],
  categories: [
