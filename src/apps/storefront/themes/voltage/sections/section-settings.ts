/**
 * Voltage — typed, fail-safe readers over a section instance's ThemeSettings (untyped record).
 * Every getter coerces + falls back, so a missing/malformed setting never throws. Voltage's own
 * copy (no Theme 01 import); mirrors the engine's documented field types.
 */
