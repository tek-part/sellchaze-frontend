/**
 * Naseem SearchOverlay — thin wrapper over the shared overlay component (focus management, ESC,
 * animated presence) with Naseem's placeholder and a direct submit to /search.
 */
