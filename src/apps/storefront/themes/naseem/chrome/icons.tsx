/** Naseem chrome icons — thin 1.75px strokes, 22px box. */
...
export const IconBag = (p: P): ReactElement => <svg {...base(p)}><path d="M6 8h12l1 13H5z" /><path d="M9 8V6a3 3 0 0 1 6 0v2" /></svg>;
