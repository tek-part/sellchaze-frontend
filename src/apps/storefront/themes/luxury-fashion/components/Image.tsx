 ...
 * (or it fails to load) it renders a hairline placeholder with a serif monogram, so a missing photo
 * still looks composed. Phase 12 layers on responsive srcset/sizes.
 */
