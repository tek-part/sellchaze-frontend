/** Rouge Textarea — matches Input; multi-line. */
...
export function Textarea(props: TextareaProps): ReactElement {
  ...
  return (
    <div className={cn('rge-field', className)}>
      <label className="rge-label" htmlFor={fieldId}>{label}</label>
      <textarea id={fieldId} ref={ref} rows={rows} className="rge-control" style={{ resize: 'vertical' }} aria-invalid={error ? true : undefined} {...rest} />
