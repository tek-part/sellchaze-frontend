/**
 * Bazaar SearchOverlay — thin wrapper over the shared overlay component (focus management, ESC,
 * animated presence) used on phones, where the inline header search is hidden.
 */
